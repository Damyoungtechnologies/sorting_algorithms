...
/**
 * max_heapify - Rearrange an array of int to form a max heap binary tree.
 * @array: Pointer to the array of integers representing a binary tree.
...
/**
 * heap_sort - Applies the heap sort algorithm
