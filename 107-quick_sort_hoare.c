...
/**
 * hoare_partition - Rearrange a subset of an array of int
...
/**
 * hoare_sort - Recursively implement the quicksort alg on an array of int.
...
/**
 * quick_sort_hoare - Applies the quicksort algorithm
 * @array: Pointer to the array of integers.
 * @size: Size of the array.
 * Description: Uses the Hoare partition scheme
 */
